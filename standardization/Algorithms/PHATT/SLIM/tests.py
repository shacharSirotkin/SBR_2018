...
if __name__ == '__main__':
    ...
    rule1 = defs.Rule.Rule(nt2, [sigma1], [],
                           [(-1, 'sid', 0, 'sid'), (-1, 'did', 0, 'did'), (-1, 'sc', 0, 'sc'), (-1, 'dc', 0, 'dc'),
                            (-1, 'vol', 0, 'vol'), (-1, 'rcd', 0, 'rcd'), (-1, 'scd', 0, 'scd'), (-1, 'dcd', 0, 'dcd'),
                            (-1, 'svol', 0, 'svol'), (-1, 'dvol', 0, 'dvol'), (-1, 'rvol', 0, 'rvol')])
    print (rule1)
    ...
    rule2 = defs.Rule.Rule(nt1, [nt2, nt2], [(0, 1)],
                           [(0, 'did', 1, 'did'), (-1, 'did', 0, 'did'), (-1, 'scd', 1, 'scd'), (-1, 'dcd', 1, 'dcd'),
                            (-1, 'rcd', 1, 'rcd')])
    print (rule2)
    ...
    rule3 = defs.Rule.Rule(nt1, [nt2, nt2], [(0, 1)],
                           [(0, 'did', 1, 'sid'), (-1, 'sid', 0, 'sid'), (-1, 'did', 1, 'did'), (-1, 'sid', 0, 'sid'),
                            (-1, 'sc', 0, 'sc'), (-1, 'dcd', 1, 'dcd'), (-1, 'rcd', 1, 'rcd')])
    print (rule3)
    print ("    right childs: ", rule3.rightChilds())  # []
    print ("    leftmost childs: ", rule3.leftMostChilds())  # [C,C]
    # SM -> MS1 SM2 | [SM1 < SM2]
    # C1.did=C2.did, C1.rcd=C2.dcd, C1.rvol=C2.dvol, C.did=C1.did, C.did=C2.did
    rule4 = defs.Rule.Rule(nt2, [nt2, nt2], [(0, 1)],
                           [(0, 'did', 1, 'did'), (-1, 'did', 0, 'did'), (-1, 'scd', 1, 'scd'), (-1, 'dcd', 1, 'dcd'),
                            (-1, 'rcd', 1, 'rcd')])
    print (rule4)
    ...
    # C1.did=C2.sid C1.rcd=C2.scd C1.rvol=C2.svol
    # C.sc=C1.sc C.dc=C2.dc C.sid=C1.sid, C.did=C2.did C.vol=C2.vol C.rcd=C2.rcd C.scd=C2.scd C.dcd=C2.dcd C.svol=C2.svol C.dvol=C2.dvol C.rvol=C2.rvol
    rule5 = defs.Rule.Rule(nt2, [nt2, nt2], [(0, 1)],
                           [(0, 'did', 1, 'sid'), (-1, 'sid', 0, 'sid'), (-1, 'did', 1, 'did'), (-1, 'sid', 0, 'sid'),
                            (-1, 'sc', 0, 'sc'), (-1, 'dcd', 1, 'dcd'), (-1, 'rcd', 1, 'rcd')])
    print (rule5)
    ...
    CSMSMsmSMSM_Tree = defs.Tree.Tree("Complex", deepcopy(nt1), rule2, [deepcopy(SMSMsmSM_Tree), deepcopy(SM_Tree)],
                                      myPL)
